...
namespace Battle
{
    public class BattleStateMachine
    {
        ...
        [Inject]
        public BattleStateMachine(BattleBeginState battleBeginState, BattleDiceRollState battleDiceRollState,
            TargetSelectState targetSelectState, DicesApplyState dicesApplyState, EndBattleState endBattleState)
        {
            _states = new Dictionary<Type, IBattleState>
            {
                [typeof(BattleBeginState)] = battleBeginState,
